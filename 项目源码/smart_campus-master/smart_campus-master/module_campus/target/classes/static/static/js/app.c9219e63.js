(window['webpackJsonp'] = window['webpackJsonp'] || []).push([['app'], {//加载app模块
    0: function (e, t, n) {
        e.exports = n('56d7')
    }, '006e': function (e, t, n) {
        'use strict'
        ...
        var a = n('e017'), i = n.n(a), c = n('21a1'), s = n.n(c), o = new i.a({
            id: 'icon-order',//图标的id
            use: 'icon-order-usage',//图标的用途
            viewBox: '-35 0 512 512.00102',//视图值
        ...
        'use strict'
        n.r(t)
        var a = n('e017'), i = n.n(a), c = n('21a1'), s = n.n(c), o = new i.a({//图像
            id: 'icon-qq',
            use: 'icon-qq-usage',
            viewBox: '0 0 128 128',
        ...
        var l = n('2b0e'), u = (n('f5df1'), n('b20f'), function () {
            ...
            p = v.exports, g = n('2f62'), w = {
                ...
                toggleSideBar: function (e) {
                    var t = e.commit
                    t('TOGGLE_SIDEBAR')//显示界面
                }, closeSideBar: function (e, t) {//关闭界面
                    var n = e.commit, a = t.withoutAnimation
                    n('CLOSE_SIDEBAR', a)
                }, toggleDevice: function (e, t) {//切换
                    var n = e.commit
                    n('TOGGLE_DEVICE', t)
                }
        ...
        W.withCredentials = !0, W.interceptors.request.use((function (e) {
            ...
            var t = e.data
            return 2e4 !== t.code && 200 !== t.code ? (P()({//出现错误
        ...
        var fe = n('8c4f'), ve = function () {
            ...
            He = function () {
                ...
                methods: {
                    toggleSideBar: function () {
                        this.$store.dispatch('app/toggleSideBar')//顶栏接口！！！！！！！！！！！！！！！！！！！！！！！
                    }, logout: function () {
                        var e = this
            ...
            je = function () {
                ...
                name: 'SidebarLogo', props: {collapse: {type: Boolean, required: !0}}, data: function () {
                    return {title: B.a.title, logo: '/images/logo.png'}//页面图标的位置
                }
            ...
            Dt = jt.exports, Pt = document, Nt = Pt.body, Rt = 992, Wt = {
                ...
                methods: {
                    handleClickOutside: function () {
                        this.$store.dispatch('app/closeSideBar', {withoutAnimation: !1})//侧栏！！！！！！！！！！！！！！！！111111
                    }
                }
                ...
                children: [{
                    ...
                    }, meta: {title: '课程管理', icon: 'clazz',userTypes: [3,1]}//！！！！！！！！！！！！！！111
                }]
            }, {
                name: 'Grade',
                path: '/grade',
        ...
        e.exports = {title: '企业内部培训管理系统', fixedHeader: !1, sidebarLogo: !0}
    }, 8644: function (e, t, n) {
        'use strict'
        n.r(t)
        var a = n('e017'), i = n.n(a), c = n('21a1'), s = n.n(c), o = new i.a({
        ...
        e.exports = {
            menuText: '#bfcbd9',//侧边导航栏中未激活（非选中）菜单项的文本颜色。
            menuActiveText: '#409eff',//侧边导航栏中激活（选中）菜单项的文本颜色。这通常用于突出显示当前用户所在的页面或功能区域。
            subMenuActiveText: '#f4f4f5',//子菜单中激活（选中）菜单项的文本颜色。这通常用于在嵌套菜单结构中突出显示当前选中的子菜单项。
            menuBg: '#304156',//侧边导航栏的背景颜色。这为用户提供了一个清晰的视觉边界，将侧边导航栏与页面的其他部分区分开来。
            menuHover: '#263445',//当鼠标悬停在侧边导航栏菜单项上时的背景颜色。这为用户提供了视觉反馈，表明他们可以通过点击来激活该菜单项。
            subMenuBg: '#1f2d3d',//子菜单的背景颜色。这有助于在视觉上区分主菜单和子菜单，同时保持侧边导航栏的整体风格一致。
            subMenuHover: '#001528',//当鼠标悬停在子菜单项上时的背景颜色。这为用户提供了进一步的视觉反馈，表明他们可以通过点击来激活该子菜单项
            sideBarWidth: '210px'//侧边导航栏的宽度。这决定了侧边导航栏在页面上占据的空间大小，以及其中可以容纳多少菜单项和子菜单项
        }
    }, b3b5: function (e, t, n) {
        'use strict'
        n.r(t)
