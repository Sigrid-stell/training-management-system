...
public class ClazzController {
    ...
    @ApiOperation("单独删除或者批量删除课程信息")
    @DeleteMapping("/deleteClazz")
    public Result<Object> deleteClazz(@ApiParam("请求体中封装的待删除的课程id集合") @RequestBody List<Integer> ids){
        if(ids.size() == 1){
