...
public class GradeController {
    ...
    @ApiOperation("单独或批量删除员工信息")
    @DeleteMapping("/deleteGrade")
    public Result<Object> deleteGrade(@ApiParam("请求体中封装的待删除的员工id集合") @RequestBody List<Integer> ids){
        if(ids.size() == 1){
            //单条记录的删除
